...
export const domainRegex = /(?:http[s]*\:\/\/)*(.*?)\.(?=[^\/]*\.)?ia\.unimas\.my/; //to read the path from url
export const domainBase = "ia.unimas.my"; // compare url with this to know should it load by path or domain
export const OAUTH = {
